...
public partial class Wrapper
{
    ...
    public static implicit operator Wrapper((object content, int code) data) =>
    ...
    public static implicit operator Wrapper((Exception e, HttpStatusCode code) data) =>
        FromError(data.e, data.code);
}